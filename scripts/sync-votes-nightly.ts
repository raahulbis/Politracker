...
/**
 * Sync latest votes from OpenParliament API for all MPs (nightly sync)
 * Only fetches votes newer than what's already in the database
 * Links votes to bills using bill_id foreign key
 */
export async function syncVotesNightly() {
  console.log('Starting Nightly Votes Sync from OpenParliament\n========================================\n');
